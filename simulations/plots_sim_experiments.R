...
# pdf("./simulations/figures/dirichletreg_allthree.pdf", width=9, height=3)
...
# 4) Block bootstrapping for all three settings ----

# pdf("./simulations/figures/bb_allthree.pdf", width=9, height=3)
